...
- [ ] **Task 26.1.3 - Harden correction timeout recovery before source freeze**
  ...
  - [ ] **Sub-task 26.1.3.6:** Rebuild and install the verified binary, then pass a fresh supervised unit and three-outcome unattended controlled-target pilot before broader unattended operation. Package C was installed and exercised, but two fresh supervised units remained incomplete; see `docs/evidence/sprint-26-package-c-live-qualification.md`.
