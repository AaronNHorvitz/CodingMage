...
- [ ] **CM-R03.2:** Reproduce-before-repair contract (CAP-10): a task authority that requires a named regression test observed failing at the base head and passing at the candidate, verified by the coordinator's gate runner, not by provider prose.
- [ ] **CM-R03.3:** Reconcile the existing exact-commit review, correction bounds and CI repair (Sprints 11, 20, 24) against CAP-15 and CAP-38 acceptance with a crosswalk of implementation, tests and evidence; record any gap as a new row rather than a claim.
