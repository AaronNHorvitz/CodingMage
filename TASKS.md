...
- [x] **Task 22.3.2 - Prepare the ten-task controlled-target campaign.** The exact downstream target
  ...
  - [x] **Sub-task 22.3.2.4:** Produce and manually inspect a source-free preflight report before the first provider invocation. The owner approved earlier digests and every resulting zero-outcome stop remains preserved. Digest `009cf73129cf77677364440c8276bb66590e392a49f49157dd5957dbd0aa948b` was consumed by an earlier attempt and no longer matches its retained manifests or current guarded binary. A fresh isolated authority now has stable digest `acbf8ca314d25b6bf91d12ad08bcd218318c66b2850c07c806ab7cd62fcb26e3` and awaits exact approval. See `docs/evidence/sprint-22-controlled-preflight.md`.
...
- [ ] **Next 1:** Obtain exact approval for fresh controlled-target preflight digest `acbf8ca314d25b6bf91d12ad08bcd218318c66b2850c07c806ab7cd62fcb26e3`, then execute and reconcile Sprint 22 Task `22.3.3` without broadening one-pod, local-only authority.
