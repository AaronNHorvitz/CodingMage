...
- [ ] **Next 1:** Complete Sprint 22 sub-task `22.2.2.2`: make control intent and applied-observation recovery crash-consistent while rejecting stale, cross-run, duplicate-effect, and unauthorized requests.
