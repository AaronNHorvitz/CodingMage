...
- [ ] **CM-R03.5a:** GitHub Enterprise host and CA policy (CAP-14): add an explicit per-host trust policy (CA bundle reference, proxy policy) to the campaign GitHub authority with fake-server fixtures for a non-`github.com` host; no claim exists today.
