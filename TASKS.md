...
- [ ] **Next 1:** Build and install transient lead-provider classification commit `39de9b2`, then resume Campaign X from its durable planning checkpoint and unchanged accepted head `1ad4759328fc253b718388131fb484ecdf2c4c25`. Run to ten accepted outcomes or the next exact safety stop. Preserve Campaign U, V, W, and X diagnostic state; do not adopt, rewrite, or delete retained evidence manually.
