...
- [ ] **Next 6:** Execute Sub-task 23.1.2.4 in stages. First produce deterministic two-pod disposable evidence for disjoint scheduling, overlap refusal, provider-capacity backpressure, independent failure, cancellation, completion-order permutation, serialized integration, and exact residue. Enable three and four pods only after the preceding stage passes and is reconciled; do not use the controlled AgentMage target for this rollout evidence.
