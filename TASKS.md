...
- [ ] **CM-R03.4:** Engineering recipes (CAP-31, P1): versioned parameterized recipe packets with declared scope, prerequisites, verification and rollback boundaries admitted through the existing task authority.
- [ ] **CM-R03.5:** Controlled Git delivery grants (CAP-14, P1): crosswalk the existing capability grants and publication policies; GitHub Enterprise host and CA policy and protected-branch behavior need fixtures before any claim.
